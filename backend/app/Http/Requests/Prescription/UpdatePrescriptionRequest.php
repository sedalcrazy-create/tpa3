...
class UpdatePrescriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prescription_type_id' => ['sometimes', 'nullable', 'exists:prescription_types,id'],
            'prescription_date' => ['sometimes', 'date'],
            'prescription_date_jalali' => ['sometimes', 'nullable', 'string', 'max:10'],
            'diagnosis_code' => ['sometimes', 'nullable', 'string', 'max:20'],
            'illness_id' => ['sometimes', 'nullable', 'exists:illnesses,id'],
            'notes' => ['sometimes', 'nullable', 'string'],
            'is_emergency' => ['sometimes', 'nullable', 'boolean'],
            'is_chronic' => ['sometimes', 'nullable', 'boolean'],
        ];
    }
